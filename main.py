...
async def start_handler(c: Client, m: Message):
    await m.reply_text(
        "Hi, I just create telegram sticker from the text messages you send me. \nMy creator @Decent_op did a Join my channel "
        "[channel](https://t.me/Octave_support) on how he created me. The link for my source is on the video "
